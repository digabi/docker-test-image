...
RUN apt-get update && \
    ...
    texlive texlive-lang-european texlive-fonts-recommended texlive-fonts-extra netcat-traditional ruby ruby-dev sudo libsystemd-dev golang vim cups-ipp-utils && \
