...
RUN apt-get update && \
    ...
    sudo -u digabi bash -c '. /home/digabi/.nvm/nvm.sh && nvm install 6.11.1 && nvm install --lts 6.9.1 && nvm install 8.3.0 && nvm install 8.9.3 && nvm install 8.11.3 && nvm install 10.0.0 && nvm install 11.11.0 && nvm install 12.4.0 && nvm install 12.6.0' && \
    sudo -u digabi bash -c 'cd ; . ~/.nvm/nvm.sh; for v in 6.11.1 8.3.0 8.9.3 8.11.3 10.0.0 11.11.0 12.4.0 12.6.0; do nvm exec $v npm install -g yarn; done' && \
    gem install fpm
